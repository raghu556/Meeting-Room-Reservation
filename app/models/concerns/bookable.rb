module Bookable
  ...
  def overlaps
    overlapping_bookings = [ 
      meeting_room.bookings.end_during(start_time, end_time),
      meeting_room.bookings.start_during(start_time, end_time),
      meeting_room.bookings.happening_during(start_time, end_time),
      meeting_room.bookings.enveloping(start_time, end_time),
      meeting_room.bookings.identical(start_time, end_time)
    ].flatten
